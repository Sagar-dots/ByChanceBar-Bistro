	...
	return (
		<div className={styles.header}>
			...
			<div className={styles.textContainer} ref={(e) => (content = e)}>
				<h1 className={styles.title}>It’s time to have a taste of Home</h1>
				<p className={styles.subtitle}>
				"Fair dinkum Aussie tucker, done proper – no fuss, no fancy prices, just bloody good pub grub.
				At By Chance Bar & Bistro, we’re all about love.
				</p>
